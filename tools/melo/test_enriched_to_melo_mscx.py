...
"""Unit tests for enriched_to_melo_mscx.py — MusicXML V3 change events.

Run: python3 tools/melo/test_enriched_to_melo_mscx.py
...
CONVERTER = os.path.join(HERE, "enriched_to_melo_mscx.py")
