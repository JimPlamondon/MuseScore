...
public:
    ...
    const std::vector<melo::TuningTrajectory>& jimsTuningTrajectories() const { return m_jimsTuningTrajectories; }
    void setJimsTuningTrajectories(const std::vector<melo::TuningTrajectory>& t) { m_jimsTuningTrajectories = t; }
    void addJimsTuningTrajectory(const melo::TuningTrajectory& t) { m_jimsTuningTrajectories.push_back(t); }
...
private:
    ...
    std::vector<melo::TuningTrajectory> m_jimsTuningTrajectories;
