...
static constexpr PropertyMetaData propertyList[] = {
    ...
    { Pid::MELO_NPER,                           P_TYPE::INT,                       PropertyGroup::NONE      , true,  "jimsNPer",                        QT_TRANSLATE_NOOP("engraving/propertyName", "JiMS period coordinate") },
    { Pid::MELO_NGEN,                           P_TYPE::INT,                       PropertyGroup::NONE      , true,  "jimsNGen",                        QT_TRANSLATE_NOOP("engraving/propertyName", "JiMS generator coordinate") },
