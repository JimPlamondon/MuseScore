...
static constexpr PropertyMetaData propertyList[] = {
    ...
    { Pid::MELO_NPER,                           P_TYPE::INT,                       PropertyGroup::NONE      , true,  "jimsNPer",                        mu::engraving::melo::diagnostic::periodCoordinate },
    { Pid::MELO_NGEN,                           P_TYPE::INT,                       PropertyGroup::NONE      , true,  "jimsNGen",                        mu::engraving::melo::diagnostic::generatorCoordinate },
