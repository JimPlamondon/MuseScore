...
public:
    ...
    bool jimsExactDeclaredExtent() const { return m_jimsExactDeclaredExtent; }
    void setJimsExactDeclaredExtent(bool value) { m_jimsExactDeclaredExtent = value; }
...
private:
    ...
    bool m_jimsExactDeclaredExtent = false;
