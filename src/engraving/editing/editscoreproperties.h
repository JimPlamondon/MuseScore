...
class ChangeMeloMelodyPart : public UndoCommand
{
    OBJECT_ALLOCATOR(engraving, ChangeMeloMelodyPart)
...
public:
    ChangeMeloMelodyPart(Score* s, melo::MelodyPart p)
        : score(s), part(p) {}
    UNDO_NAME("ChangeMeloMelodyPart")
    UNDO_CHANGED_OBJECTS({ score })
};
