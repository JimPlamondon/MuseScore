...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    ...
    { Sid::meloDoLineColor, "jimsDoLineColor", Color("#E03030") },
    { Sid::meloMidFrameLineColor, "jimsMidFrameLineColor", Color("#E0C020") },
    { Sid::meloJiLimit3Color, "jimsJiLimit3Color", Color("#9040C0") },
    { Sid::meloJiLimit5Color, "jimsJiLimit5Color", Color("#209040") },
    { Sid::meloJiLimit7Color, "jimsJiLimit7Color", Color("#2060D0") },
    { Sid::meloJiLimit11Color, "jimsJiLimit11Color", Color("#40A8E0") },
    { Sid::meloChangeArrowColor, "jimsChangeArrowColor", Color("#000000") },
    { Sid::meloMidBarFlankColor, "jimsMidBarFlankColor", Color("#808080") },
    { Sid::meloElideEmptyOctaves, "jimsElideEmptyOctaves", false },
    { Sid::meloShowAllOctavesInFirstSystem, "jimsShowAllOctavesInFirstSystem", true },
