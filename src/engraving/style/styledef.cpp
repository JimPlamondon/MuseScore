...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    ...
    styleDef(jimsDoLineColor, Color("#E03030")),
    styleDef(jimsMidFrameLineColor, Color("#E0C020")),
    styleDef(jimsJiLimit3Color, Color("#9040C0")),
    styleDef(jimsJiLimit5Color, Color("#209040")),
    styleDef(jimsJiLimit7Color, Color("#2060D0")),
    styleDef(jimsJiLimit11Color, Color("#40A8E0")),
    styleDef(jimsChangeArrowColor, Color("#000000")),
    styleDef(jimsMidBarFlankColor, Color("#808080")),
