...
The decisive acceptance run used unmodified JS80P as the source for 24 syntonic generator widths from 686 through 720 cents and eight successive major-triad windows per tuning. Its 192 analyzed windows had a 0.000214% 95th-percentile Timbre Gap outside intended partial moves, a 0.000456% maximum gap, a 0.000000144-cent maximum fundamental change, and less than 0.0001 dB maximum added steady-state sample-step discontinuity. Median mapped-partial alignment improved by 1.23 dB. The result passed.

Surge XT was also exercised without modification. After effect-readiness was fixed, it showed a 30.94 dB median mapped-partial alignment improvement and a 0.0251-cent maximum fundamental delta, proving that JiMSTimbre was acting on its output. Its default patch did not pass the strict Timbre Gap oracle because repeat renders were not sufficiently equivalent outside the permitted relocation bands, so Surge XT is supporting interoperability evidence rather than the acceptance source.
